...
import org.omnirom.omnigears.preference.SoundSelectPreference;
...
public class StyleSettings extends SettingsPreferenceFragment implements
    ...
    private static final String KEY_UNLOCK_SOUND ="unlock_sound_config";
    private static final String KEY_LOCK_SOUND ="lock_sound_config";
    ...
    private SoundSelectPreference mUnlockSoundPreference;
    private SoundSelectPreference mLockSoundPreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUnlockSoundPreference = (SoundSelectPreference) findPreference(KEY_UNLOCK_SOUND);
        final String unlockSound = Settings.Global.getString(getContentResolver(),
                Settings.Global.UNLOCK_SOUND);
        Log.d("maxwen", "unlockSound = " + unlockSound);
        if (unlockSound != null) {
            valueIndex = mUnlockSoundPreference.findIndexOfValue(unlockSound);
                                Log.d("maxwen", "unlockSound = " + valueIndex);

        }
        mUnlockSoundPreference.setValueIndex(valueIndex >= 0 ? valueIndex : 0);
        mUnlockSoundPreference.setOnPreferenceChangeListener(this);

        mLockSoundPreference = (SoundSelectPreference) findPreference(KEY_LOCK_SOUND);
        final String lockSound = Settings.Global.getString(getContentResolver(),
                Settings.Global.LOCK_SOUND);
        Log.d("maxwen", "lockSound = " + lockSound);
        if (lockSound != null) {
            valueIndex = mLockSoundPreference.findIndexOfValue(lockSound);
                    Log.d("maxwen", "lockSound = " + valueIndex);

        }
        mLockSoundPreference.setValueIndex(valueIndex >= 0 ? valueIndex : 0);
        mLockSoundPreference.setOnPreferenceChangeListener(this);
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        } else if (preference == mUnlockSoundPreference) {
            String value = (String) newValue;
            Log.d("maxwen", "unlockSound = " + value);
            Settings.Global.putString(getContentResolver(),
                    Settings.Global.UNLOCK_SOUND, value);
        } else if (preference == mLockSoundPreference) {
            String value = (String) newValue;
                        Log.d("maxwen", "lockSound = " + value);

            Settings.Global.putString(getContentResolver(),
                    Settings.Global.LOCK_SOUND, value);
        }
        return true;
    }
